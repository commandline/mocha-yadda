...
function tagsMatch(tags, annotations) {
    ...
    return _.size(_.pick(feature.annotations, lowerTags)) === 0;
}
...
var withLang = function(lang) {
    ...
    var loadAndDescribe = function(featureSpec, stepLibraries, options) {
        ...
        loader.load(featureSpec).then(function (featureFile) {
            ...
            var scenarioTagOverride = false;
            if (options.tags && feature.annotations && tagsMatch(options.tags, feature.annotations)) {
                return;
            } else {
                scenarioTagOverride = true;
            }
